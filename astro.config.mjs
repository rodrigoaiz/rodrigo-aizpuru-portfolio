...
export default defineConfig({
  integrations: [tailwind(), partytown({
    ...
    include: {
      bi: ['facebook', 'twitter-x', 'youtube', 'instagram', 'linkedin', 'github', 'behance','envelope-paper-heart','file-earmark-arrow-down', 'box-arrow-in-right', 'arrow-left', 'link-45deg', 'plus-circle-dotted'],
